...
function UploadJson() {
    ...
    const handleRefresh = () => {
        ...
        setReviews([]);
        setResults([]);
        setSummary({ positive: 0, negative: 0, neutral: 0 });
        setError("");
        setLoading(false);
    };

        return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-500 to-pink-500 flex flex-col items-center justify-center bg-gray-100 p-5">
